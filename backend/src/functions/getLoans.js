...
app.http('getLoans', {
    ...
    handler: async (request, context) => {
        context.log(`getLoans called at "${request.url}"`);
        ...
        try {
            ...
            if(specificID) {
                ...
                result = await pool.request()
                    ...
                    .query(`SELECT
                        ...
                        INNER JOIN membership.Members on Loans.MemberID = membership.Members.ID
            ...
            return {
                status: 500,
                body: "Failed to retrieve loans from database."
            }
        }
    }
});
