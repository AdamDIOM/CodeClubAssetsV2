...
export default function KTTable({ loans, edit }) {
      ...
      <table className="top-40 w-full border border-club-orange-300 dark:border-club-green-500 shadow rounded-2xl overflow-hidden bg-white dark:bg-neutral-800">
        <thead className="sticky top-0 z-9 bg-club-orange-400 dark:bg-club-green-800 text-neutral-700 dark:text-neutral-300 text-left text-sm">
          <tr>
            ...
            <th className="px-4 py-2 border-b md:table-cell hidden">User(s)</th>
            <th className="px-4 py-2 border-b">Status</th>
            <th className="px-4 py-2 border-b lg:table-cell hidden">Last Used</th>
            ...
            return (
                <React.Fragment key={loan.ID}>
                    ...
                    <tr key={loan.ID} className={`
                        ...
                        <td className="px-4 py-2 border-b md:table-cell hidden">{loan.Members || '—'}</td>
                        <td className="px-4 py-2 border-b ">{status}</td>
                        <td className="px-4 py-2 border-b lg:table-cell hidden">{startDate.toLocaleDateString() || '—'}</td>
                        ...
                        {isExpanded && (
                            <tr className="">
                                ...
                                <td colSpan={8} className="px-4 py-2 bg-club-orange-50 dark:bg-club-green-900 border-b text-neutral-700 dark:text-neutral-300">
                                    <InnerDiv loan={loan}/>
                                </td>
                            </tr>
                        )}
