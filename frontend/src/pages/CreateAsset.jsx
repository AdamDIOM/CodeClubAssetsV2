...
export default function Create() {
    ...
    const [form, setForm] = useState({ ID: '', Name: '', Description: '', Location: '', SerialNumber: '', ParentID: '', Tags: '', TestsRequired: 0, Out: 0, Deleted: 0 });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if(!clear){
                setForm({ ID: '', Name: '', Description: '', Location: '', SerialNumber: '', ParentID: '', Tags: '', TestsRequired: 0, Out: 0, Deleted: 0 })
            } else {
